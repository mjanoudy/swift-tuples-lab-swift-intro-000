 ...
 */
var someone = (name: "Mawia Janoudy", age: 27)
 ...
 */
let human = (name: "Killian Mbappe", age: 19)
 ...
 */
// we cannot because we declared human as a constant instead of a variable tuple
